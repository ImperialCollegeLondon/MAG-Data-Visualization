classdef tBartingtonApp < AppTestCase
% TBARTINGTONAPP System tests for Bartington version of "DataVisualization"
% app.
    ...
    methods (Test)
        ...
        function analyze_fullWorkflow(testCase, TestDetails)
            ...
            app = testCase.createAppWithCleanup("Bartington");
