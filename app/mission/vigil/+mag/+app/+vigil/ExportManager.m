...
% EXPORTMANAGER Manager for export of Vigil analysis.
    ...
    methods
        ...
        function instantiate(this, parent)
            ...
            uilabel(this.ExportSettingsLayout, Text = "No export options for Vigil yet.", HorizontalAlignment = "center", VerticalAlignment = "center");
