...
% SPECTROGRAM View-controller for generating "mag.hs.view.Spectrogram".
    ...
    methods
        ...
        function command = getVisualizeCommand(this, results)
            ...
            command = mag.app.Command(Functional = @(varargin) mag.hs.view.Spectrogram(varargin{:}).visualizeAll(), ...
