...
% SCIENCECDF Format Solar Orbiter science data for CDF import.

    properties (Constant, Access = private)
        L2FileNamePattern (1, 1) string = "solo_L2_mag-(?<frame>\w+)-(?<mode>\w+?)_(?<date>\d+)_(?<version>.+?)\.cdf"
    end
    ...
    methods
        ...
        function this = ScienceCDF(options)
            ...
            arguments
                options.?mag.solo.in.ScienceCDF
            end
