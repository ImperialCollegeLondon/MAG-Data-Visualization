...
%#ok<*AGROW>
    ...
    properties (Constant, Access = private)
        ...
        SecondaryCurrentsWarningLimits (1, 1) dictionary = dictionary( ...
            ...
            P8VI = {[110, 222]}, ...
            N8VI = {[80, 180]})
        VoltageCurrentToHumanReadableConversion (1, 1) dictionary = dictionary( ...
            P1V5V = "+1.5 V Voltage", ...
            P1V8V = "+1.8 V Voltage", ...
            P3V3V = "+3.3 V Voltage", ...
            P2V5V = "+2.5 V Voltage", ...
    ...
    methods (Access = private)
        ...
        function checkSecondaryVoltages(this, pwr)
            ...
            for r = results
                r.Name = this.VoltageCurrentToHumanReadableConversion(r.Name);
            end
        ...
        function checkSaturation(this, pwr)
            ...
            if isempty(failedAxes)
                ...
                description = "No saturation on any sensor/axis.";
            else
        ...
        function checkMissedITFFrames(this, pwr)
            ...
            if any(pwr.MissedITF > 0)
                ...
                status = mag.health.Status.Fail;
                description = compose("%s missed ITF frames.", max(pwr.MissedITF));
            else
