        ...
        function visualize(this)
            ...
            if pwr.isPlottable()
                ...
                this.Figures(1) = this.Factory.assemble( ...
                    ...
                    Name = compose("HK Time Series (%s)", this.date2str(pwr.Time(1))), ...
                    Arrangement = [6, 2], ...
                    LinkXAxes = true, ...
                ...
                if ~isempty(this.Results.Science)
                    ...
                    this.Figures(end + 1) = this.Factory.assemble( ...
                        ...
                        Name = compose("+-8V Close Up (%s)", this.date2str(pwr.Time(1))), ...
                        Arrangement = [3, 1], ...
                        LinkXAxes = true, ...
                        WindowState = "maximized");
                    ...
                    if ~isempty(primary.Events) && ~isempty(secondary.Events)
                        ...
                        this.Figures(end + 1) = this.Factory.assemble( ...
                            ...
                            primary.Events, mag.graphics.style.Default(Title = compose("%s Modes", primarySensor), YLabel = "mode [-]", YLimits = "manual", Charts = mag.imap.chart.Event(EventOfInterest = "DataFrequency", EndTime = primary.Time(end))), ...
                            ...
                            primary.Events, mag.graphics.style.Default(Title = compose("%s Ranges", primarySensor), YLabel = "range [-]", YLimits = "manual", Charts = mag.imap.chart.Event(EventOfInterest = "Range", YOffset = 0.1, IgnoreMissing = false, EndTime = primary.Time(end))), ...
                            secondary.Events, mag.graphics.style.Default(Title = compose("%s Ranges", secondarySensor), YLabel = "range [-]", YLimits = "manual", YAxisLocation = "right", Charts = mag.imap.chart.Event(EventOfInterest = "Range", YOffset = 0.1, IgnoreMissing = false, EndTime = secondary.Time(end))), ...
                            Name = compose("HK & Events (%s)", this.date2str(pwr.Time(1))), ...
                            Arrangement = [4, 2], ...
                            LinkXAxes = true, ...
                            WindowState = "maximized");
                    end
            ...
            if sid5.isPlottable()
                ...
                this.Figures(end + 1) = this.Factory.assemble( ...
                    ...
                    sid5FOBTable, mag.graphics.style.Default(Title = compose("%s Modes", primarySensor), YLabel = "mode [-]", YLimits = "manual", Charts = mag.imap.chart.Event(EventOfInterest = "Rate", IgnoreMissing = false)), ...
                    sid5FIBTable, mag.graphics.style.Default(Title = compose("%s Modes", secondarySensor), YLabel = "mode [-]", YLimits = "manual", YAxisLocation = "right", Charts = mag.imap.chart.Event(EventOfInterest = "Rate", IgnoreMissing = false)), ...
                    sid5FOBTable, mag.graphics.style.Default(Title = compose("%s Ranges", primarySensor), YLabel = "range [-]", YLimits = "manual", Charts = mag.imap.chart.Event(EventOfInterest = "Range", IgnoreMissing = false, YOffset = 0.25)), ...
                    sid5FIBTable, mag.graphics.style.Default(Title = compose("%s Ranges", secondarySensor), YLabel = "range [-]", YLimits = "manual", YAxisLocation = "right", Charts = mag.imap.chart.Event(EventOfInterest = "Range", IgnoreMissing = false, YOffset = 0.25)), ...
                    sid5FOBTable, mag.graphics.style.Default(Title = compose("%s Compression", primarySensor), YLabel = "compressed [-]", YLimits = "manual", Charts = mag.imap.chart.Event(EventOfInterest = "Compression", IgnoreMissing = false, YOffset = 0.1)), ...
                    sid5FIBTable, mag.graphics.style.Default(Title = compose("%s Compression", secondarySensor), YLabel = "compressed [-]", YLimits = "manual", YAxisLocation = "right", Charts = mag.imap.chart.Event(EventOfInterest = "Compression", IgnoreMissing = false, YOffset = 0.1)), ...
                    Title = "Science HK", ...
                    Name = compose("Science HK Time Series (%s)", this.date2str(sid5.Time(1))), ...
                    Arrangement = [6, 2], ...
                    LinkXAxes = true, ...
                    WindowState = "maximized");
            end
            ...
            if status.isPlottable() && procStat.isPlottable() && sid15.isPlottable()
                ...
                timestamp = min([status.Time(1), procStat.Time(1), sid15.Time(1)]);
                ...
                this.Figures(end + 1) = this.Factory.assemble( ...
                    ...
                    Name = compose("Processor Stats (%s)", this.date2str(timestamp)), ...
                    Arrangement = [3, 1], ...
                    LinkXAxes = true);
            end
        end
