...
% PACKAGETASK Package code into toolbox.
    ...
    methods (Hidden, TaskAction)
        ...
        % PACKAGETOOLBOX Package code into toolbox.
            ...
            disp(compose("Path: %s", fileparts(task.ToolboxPath)))
            ...
            toolboxOptions.ToolboxFiles = fullfile(task.ProjectRoot, ["app", "src"]);
            toolboxOptions.ToolboxMatlabPath = task.getMATLABPath();
