...
% PSD Show PSD of magnetic field.
    ...
    methods (Access = private)
        ...
        function charts = getPSDCharts(this, psd, sensor)
            ...
            charts = {psd, ...
                [mag.graphics.style.Default(Title = compose("%s PSD", sensor), XLabel = this.FLabel, YLabel = "x "+this.PSDLabel, XScale = "log", YScale = "log", ...
                Charts = [mag.graphics.chart.Plot(XVariable = "Frequency", YVariables = "X"), this.NoiseThreshold.getChart()]),...
                mag.graphics.style.Default(Title = compose("%s PSD", sensor), XLabel = this.FLabel, YLabel = "y "+this.PSDLabel, XScale = "log", YScale = "log", ...
                Charts = [mag.graphics.chart.Plot(XVariable = "Frequency", YVariables = "Y"), this.NoiseThreshold.getChart()]),...
                mag.graphics.style.Default(Title = compose("%s PSD", sensor), XLabel = this.FLabel, YLabel = "z "+this.PSDLabel, XScale = "log", YScale = "log", ...
                Charts = [mag.graphics.chart.Plot(XVariable = "Frequency", YVariables = "Z"), this.NoiseThreshold.getChart()])]};
        end
