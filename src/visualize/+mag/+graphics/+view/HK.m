    ...
    methods
        ...
        function visualize(this)
            ...
            if ~isempty(sid5)
                ...
                this.Figures(end + 1) = this.Factory.assemble( ...
                    sid5, ...
                    [mag.graphics.style.Stackedplot(Title = primarySensor, YLabels = ["x [nT]", "y [nT]", "z [nT]", "|B| [nT]", "R [-]"], Charts = mag.graphics.chart.Stackedplot(XVariable = "FOBT", YVariables = "FOB" + ["X", "Y", "Z", "B", "Range"])), ...
                    mag.graphics.style.Stackedplot(Title = secondarySensor, YLabels = ["x [nT]", "y [nT]", "z [nT]", "|B| [nT]", "R [-]"], YAxisLocation = "right", Charts = mag.graphics.chart.Stackedplot(XVariable = "FIBT", YVariables = "FIB" + ["X", "Y", "Z", "B", "Range"]))], ...
                    Title = "Science HK", ...
