    ...
    methods
        ...
        function visualize(this)
            ...
            if hasIALiRT
                ...
                this.Figures(end + 1) = this.Factory.assemble( ...
                    secondaryIALiRTComparison, primaryGraphs, secondaryIALiRTComparison, secondaryGraphs, ...
            ...
            if hasSID5
                ...
                this.Figures(end + 1) = this.Factory.assemble( ...
                    secondarySID5Comparison, primaryGraphs, secondarySID5Comparison, secondaryGraphs, ...
